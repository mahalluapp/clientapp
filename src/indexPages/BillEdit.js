...
import { updateSheet } from '../swrApi/helperApis';
...
const BillEdit = () => {
    ...
    const { data: billData, isLoading, error, mutate } = useSWR(location.state?.details !== null ? { url: '/exec', args: location.state.details } : null, generateBill, {
